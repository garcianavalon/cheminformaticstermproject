...
public class ECFFragmenter {
	...
	private IAtom starAtom = new Atom("C");
	...
	/**
	 * Remove duplicates and store the result as a List of canonical SMILES Strings
	 *  paired with their count
	 */
	...
	/**
	 * Returns the set of fragments generated by the last call of
	 * generateFragments() as Pairs of Integers, representing their 
	 * Hashvalues and count, null if the method hasn't been called yet.
	 * 
	 * @return The generated Fragments
	 */
	public ArrayList<AbstractMap.SimpleEntry<Integer, Integer>> getFragmentsAsKeyValuePairs() {
		if (this.fragmentCount == null) return null;
		...
		for (AbstractMap.SimpleEntry<String, Integer> entry : this.fragmentCount) 
			keyValuePairs.add(new SimpleEntry<Integer, Integer>(entry.getKey().hashCode(), entry.getValue()));
